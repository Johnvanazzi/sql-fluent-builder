...
public class TestInsert : BaseConfig
{
    ...
    {
        string result = _query.Insert(_schema, _table).ToSql();
    ...
    {
        string result = _query.Insert(_table).ToSql();
    ...
    {
        string result = _query.Insert(_schema, _table, _columns).ToSql();
    ...
    {
        string result = _query.Insert(_table, _columns).ToSql();
    ...
    {
        Action action1 = () => _query.Insert(_schema, _table, Array.Empty<string>());
        Action action2 = () => _query.Insert(_table, Array.Empty<string>());
